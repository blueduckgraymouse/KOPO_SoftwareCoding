...
<head>
	...
	<%
		...
		String no_hubo = request.getParameter("no_hubo");	// 삭제할 후보번호를 파라미터로 받아 변수에 저장
		...
		String query = "delete from hubo_table where id=" + no_hubo + ";";	// 파라미터로 받은 후보번호의 레코드를 삭제하는 쿼리 저장
		stmt.execute(query);						// 파라미터로 받은 후보번호의 레코드를 삭제 실행
...
<body>
	<div align="center">
		...
		<b>후보 등록 결과 : 후보가 삭제되었습니다.</b>		<!-- 삭제 완료 메세지 출력 -->
