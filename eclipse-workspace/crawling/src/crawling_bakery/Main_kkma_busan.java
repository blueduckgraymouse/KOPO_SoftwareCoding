...
public class Main_kkma_busan {
	...
	public static void main(String[] args) throws IOException {
		File f = new File("C:\\KOPO\\git_tracking\\기본프로그래밍_java\\crawling\\bakery\\data\\bakery_list_busan.csv");
		BufferedReader br = new BufferedReader(new FileReader(f));
		
		File wf = new File("C:\\KOPO\\git_tracking\\기본프로그래밍_java\\crawling\\bakery\\data\\keyword_busan.csv");
		...
		String line_read = "";
		String contents = "";
		while((line_read = br.readLine()) != null) {	// 모든 제목 contents문자열에 누적
