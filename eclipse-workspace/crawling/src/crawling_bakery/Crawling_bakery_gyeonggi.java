...
public class Crawling_bakery_gyeonggi {
	...
	public static void main(String[] args) throws IOException {
		...
		File f = new File("C:\\KOPO\\git_tracking\\기본프로그래밍_java\\crawling\\bakery\\bakery_list_gyeonggi.csv");
		BufferedWriter bw = new BufferedWriter(new FileWriter(f));
		
		
		// "서울 빵 맛집"이라고 검색창에 입력
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"query\"]"))).sendKeys("경기 빵 맛집");
		wait200ms();
