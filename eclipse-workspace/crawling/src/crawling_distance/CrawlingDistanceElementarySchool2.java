			...
			for(int i = 13 ; i < guSize ; i++) {
				...
				for(int j = 3 ; j <= dongSize ; j++) {
					...
					for(int k = 1 ; k <= complexSize ; k++) {
						...
						System.out.println(guName + " - " + dongName + " - " + complexName + " - " + priceRange + " - " + complexScale + " - " + distance);
						
						bw.write(guName + "," + dongName + "," + complexName + "," + priceRange.replaceAll(",", "") + complexScale + "," + distance);
