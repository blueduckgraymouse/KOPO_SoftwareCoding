...
public class K35_Ex06 {
	...
	public static void main(String[] args) {
		...
		String[] k35_itemname = {"해피홈 SAFE365 핸드워시(펌프형)", "(G)LH원형유리화병 100ml", "건포도", "오렌지주스", "초코에몽", "abc초콜렛", "서울우유" ,"크래미", "포카칩", "프링글스 오리지날",
								"고등어", "양배추", "고구마", "감자", "비비고 만두", "티코", "하겐다즈", "텀블러", "모니터", "노트북",
								"선풍기", "프린터", "한우 등심", "한우 안심", "키보드", "마우스", "카누", "대파", "1+ 등급란 10개입 특란", "동원양반볶음김치기"};
		int[] k35_price = 		{7500, 1200, 13000, 3000, 1000, 500, 3800, 3300, 2000, 1700,
		...
		for (int k35_i = 0 ; k35_i < k35_itemname.length ; k35_i++) {						// 46 = 3 + 20 + 9 + 4 + 10
			...
			total += k35_price[k35_i] * k35_num[k35_i];
