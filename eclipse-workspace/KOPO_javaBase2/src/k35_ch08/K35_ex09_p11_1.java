 ...
 * 
 * 스스로 실습 - p11
 *  실습1 : 삼성전자(단축코드 A005930)만 추출하여 파일 생성
 * 
 * @author KOPO
 *
 */
public class K35_ex09_p11_1 {
	...
	public static void main(String[] args) throws IOException {
		...
		File k35_f_write = new File("C:\\KOPO\\git_tracking\\소프트웨어코딩(v2022)-자바심화\\8강\\A005930.csv");			// 내용을 쓸 파일의 경로를 파라미터로 전달한 file객체 생성 훟 변수에 저장
		...
		while ((k35_readtxt = k35_br.readLine()) != null) {							// 파일의 모든 내용을 읽을 때까지 반복
			...
			if(k35_datas[2].contains("A005930")) {									// 단축코드에 해당하는 3번째 데이터가 삼성성자의 단축코드이면
