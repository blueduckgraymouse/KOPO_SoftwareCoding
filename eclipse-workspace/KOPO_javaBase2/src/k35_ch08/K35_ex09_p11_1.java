...
public class K35_ex09_p11_1 {
	...
	public static void main(String[] args) throws IOException {
		...
		File k35_f_write = new File("C:\\KOPO\\git_tracking\\소프트웨어코딩(v2022)-자바심화\\8강\\A005930_2.csv");
		...
		while ((k35_readtxt = k35_br.readLine()) != null) {
			String abc = k35_readtxt.substring(22, 29);
			//String[] k35_datas = k35_readtxt.split(",");
			//if(k35_datas[2].contains("A005930")) {
			if(abc.equals("A005930")) {
