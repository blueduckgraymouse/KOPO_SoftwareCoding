	...
	public static void main(String[] args) {
		...
		for (int k35_i = 1 ; k35_i < 13 ; k35_i++) {			// 1월에서 12월까지 출력하기 위해 i변수를 1~12까지 반복
			...
			LOOP : for (int k35_j = 1; k35_j < 32 ; k35_j++) {	// i의 해당 달의 모든 날짜를 출력하기 위해서 j를 1~31까지 반복, 한 달에 최대 31일까지 있기 때문
				...
				switch (k35_i) {
					case 4: case 6: case 7: case 9: case 11:	// 4, 6, 9, 11월은 30일까지 있으므로 j가 30이면 반복문 종료
						if (k35_j==30)
							break LOOP;							// break 뒤에 LOOP를 사용하여 break할 반복문을 지정하였다.
						...
						if (k35_j==28)							// 2월은 28일까지 있으므로 j가 28이면 반복문 종료
							break LOOP;
				}
			}
			System.out.printf("\n");
