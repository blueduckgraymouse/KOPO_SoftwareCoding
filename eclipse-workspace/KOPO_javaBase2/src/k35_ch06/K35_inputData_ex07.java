...
public class K35_inputData_ex07 {
	// 학생의 점수를 저장되는 변수
	...
	// 생성자
	public K35_inputData_ex07(int k35_iPerson) {	// 파라미터로 몇 명의 학생에 대한 정보를 담을지 받아와
	...
	// 과목별 성적 집계(평균)하는 메서드
	public void k35_total() {
		int k35_size = k35_name.length;					// 총 학생의 수
