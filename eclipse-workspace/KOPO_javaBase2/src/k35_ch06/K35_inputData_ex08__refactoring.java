...
public class K35_inputData_ex08__refactoring {
	// 학생의 점수를 저장되는 변수
	...
	// 학생의 점수를 저장 완료 후 평균 집계에 사용되는 변수
	...
	// 생성자
	public K35_inputData_ex08__refactoring(int k35_iPerson) {	// 파라미터로 몇 명의 학생에 대한 정보를 담을지 받아와
	...
	public void k35_total(int k35_index_start, int k35_index_end) {
		...
		for (int k35_i = k35_index_start ; k35_i < k35_index_end ; k35_i++) {
			k35_sum_kor += k35_kor[k35_i];
			k35_sum_eng += k35_eng[k35_i];
			k35_sum_mat += k35_mat[k35_i];
			k35_sum_sum += k35_sum[k35_i];
			k35_sum_ave += k35_ave[k35_i];
		}
