...
public class K35_ex08_p40 {
	...
	public static void main(String[] args) {
		int k35_iPerson = 57;													// 점수 통계 할 총 인원 설정
		...
		k35_inData.k35_final_total();													// 누적 데이터로 과목별 평균 및 모든 성적 합게 및 평균 집계하는 메서드 호출
		
		k35_print_all(k35_inData);
		
	}
	
	private static void k35_print_all(K35_inputData_ex08 k35_inData) {
		// 성적집계표 출력
		int k35_index = 0;
		...
		k35_print_all_total(k35_inData);
	}
	...
	private static void k35_print_date() {
		...
		System.out.println("\t\t\t출력일자 : " + k35_sdf.format(k35_calendar.getTime()));		// 현재 일자를 출력일자로 출력
	}
	
	// 학생들의 데이터를 출력하는 메서드
	private static int k35_print_score(int k35_index, K35_inputData_ex08 k35_inData) {
		int k35_i;
		for (k35_i = k35_index; k35_i < k35_inData.k35_name.length && k35_i < k35_index + 30 ; k35_i++) {
			System.out.printf("%4d%2s", k35_i + 1, "");										// 번호 출력
			System.out.printf("%-6s", k35_inData.k35_name[k35_i]);							// 이름 출력
	...
	private static void k35_print_total(K35_inputData_ex08 k35_inData, int k35_index_start, int k35_index_end) {
		...
		System.out.printf("%7.0f%2s\n", k35_inData.k35_sum_ave, "");						// 모든 학생의 3과목의 평균 누적 합계 출력
		...
		System.out.printf("%7.0f%2s\n\n", k35_inData.k35_ave_ave, "");
	}
	
	// 모든 학생들의 데이터를 집계한 최종 정보(합계, 평균)를 출력하는 메서드
	private static void k35_print_all_total(K35_inputData_ex08 k35_inData) {
